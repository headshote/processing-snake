...
public void draw()
{
  ...
  frameParity = (frameParity+1)%2; //every other frame
  ...
  if( playing)
  {
    if (frameParity == 1) //decreses movement speed of snake without affecting fps
      snake.move();
...
public void checkScore(Snake snake)
{
...
class Effect1
{
  ...
  public class Ball {
    ...
    Ball(float x, float y) {
      ...
      age = PApplet.parseInt(random(20, MAX_BALL_AGE));
      size = 0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Something" };
    if (passedArgs != null) {
